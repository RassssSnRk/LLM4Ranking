...
for data in ['dl19']:
    ...
    #print(rank_results[0]['hits'][0])
    # rank_results : item : query, hits : {content, qid, rank ,item, docid, score}
    # 43 items, each items has 100 hits(rank 1 ~ 100)
    ...
    for item in tqdm(rank_results):
        ...
        new_item = sliding_windows(item, rank_start=0, rank_end=100, window_size=20, step=10,
                                  model_name='gpt-4o-mini', api_key=openai_key)
