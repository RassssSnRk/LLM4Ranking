...
from llmrankers.pointwise import OpenAiPointwiseLlmRanker, PointwiseLlmRanker, MonoT5LlmRanker
...
def main(args):
    ...
    if args.pointwise:
        if  args.run.openai_key:
            ranker = OpenAiPointwiseLlmRanker(model_name_or_path=args.run.model_name_or_path,
    ...
    print("check point : ranker :", ranker.llm)
    ...
    print("check point loading first stage run")
